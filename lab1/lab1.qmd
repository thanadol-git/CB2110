...
There will be ten questions and three bonus questions for you to answer. Please try to elaborate this exercise with the lectures from the first week. The goal of this lab is for you to enjoy mass spectrometry data much more. MS is an intriguing technology. In other words, it is not that simple to understand it within a few minutes but we are here to explore them all together. Nevertheless, we try to reduce several steps into just a simple exercise. 
...
We have created a simple exercise for you on <https://github.com/thanadol-git/quantms_example/>. Please try to follow it along with answering the questions here. The TA will try to help you in the class so don't worry if it looks a bit difficult. We are always here to help. I would suggest here for you to spend some time setting up the container and nextflow following the instructions on the page. It is not a difficult process but it may take some time with your laptop. Once you are at **Step 3. Running**, you may start answering the questions here. Just write down your answer under the question.
...
## Q2.
**What is the PRIDE accession ID for this dataset? Summarise the experiment in a short paragraph (<100 words).**
...
## Q5. 
<em>Now, you need a proteome to search with your experiment. Please just go to Uniprot.</em> **What proteome did you download from Uniprot? How many proteins are there?**
...
**Once you run the pipeline with quantms, what is the name of the peptide identification step?**
...
Hooray! Once you finish answering the questions, please render this markdown to pdf and upload it on Canvas together with the results file in <em>proteomicslfq </em> folder.
