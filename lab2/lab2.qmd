...
## Q7. 
**From `select_pept` table, remove the peptides that are not detected in more than 50% of the samples. How many protiens and peptides are left?**
...
## Q8.
**Calculate the missing data in the dataset. What is the protein concentration in each sample**
...
## Q10. 
**Visualize the concentration of protein from PSMB3 gene with boxplot. What can we summarise here? What shall we find next?**
```{r}
# hint
# Fix this code below
...
## BQ3.
**What are the advanageous and dis advantageous of MS acquition?**
