...
## Q2. 
**Let's check the peptides and proteins. How many unique proteins and peptides?**
```{r}
...
## Q4. 
**Pick one protein that is comprised of 10 detectable peptides. Visulize the peptide intensity. Does every peptide have the same intensity in each sample for each  peptide. If not, why?**
